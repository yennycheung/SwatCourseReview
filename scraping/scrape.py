...
def populateDeptSearchKey():
	...
	DEPT_SEARCH_KEY["clst"] = ["classical", "studies"]
	DEPT_SEARCH_KEY["cogs"] = ["cognitive", "science", "cogsci"]
	DEPT_SEARCH_KEY["cpsc"] = ["computer", "science", "cs", "compsci"]
	DEPT_SEARCH_KEY["econ"] = ["economics"]
	DEPT_SEARCH_KEY["educ"] = ["educational" "studies", "educational", "study"]
	DEPT_SEARCH_KEY["engr"] = ["engineering", "e"]
	DEPT_SEARCH_KEY["engl"] = ["english", "literature", "english", "literature"]
	DEPT_SEARCH_KEY["envs"] = ["environmental", "studies", "environmental", "study"]
	DEPT_SEARCH_KEY["fmst"] = ["film", "media", "studies", "film", "media", "study"]
	...
	DEPT_SEARCH_KEY["lasc"] = ["latin", "american", "studies", "latin", "american", "study"]
